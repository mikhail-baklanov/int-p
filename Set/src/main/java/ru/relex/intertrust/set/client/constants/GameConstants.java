...
public interface GameConstants extends com.google.gwt.i18n.client.Constants {
  ...
  /**
   * Translated "Неверное имя или такой игрок уже существует".
   * 
  ...
  /**
   * Translated "С начала игры прошло:".
   * 
  ...
  /**
   * Translated "Игра начнется через:&nbsp;".
   * 
